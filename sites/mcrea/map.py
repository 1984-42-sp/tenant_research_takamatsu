...
INPUT_CSV = Path("output/mcrea/mcrea.csv")

GEOCODED_CSV = Path("output/mcrea/mcrea_geocoded.csv")
FAILED_CSV = Path("output/mcrea/mcrea_geocode_failed.csv")
MAP_HTML = Path("output/mcrea/mcrea_map.html")
